...
//                sp.edit().putString("userID", "0").apply();
        ...
        Toast.makeText(HomeScreen.this, sp.getString("userID", "0"), Toast.LENGTH_LONG).show();
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeScreen.this, QuizSubjectActivity.class);
                startActivity(intent);
            }
        });
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeScreen.this, Facilities.class));
            }
        });
