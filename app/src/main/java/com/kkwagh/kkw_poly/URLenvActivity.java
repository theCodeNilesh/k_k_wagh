...
public class URLenvActivity {
    public static String ip = "polyapp.kkwagh.edu.in";
    public static String login_api = "http://" + ip + "/kkwp_appbackend/login_api.php";
    public static String get_userId = "http://" + ip + "/kkwp_appbackend/get_userID.php";
